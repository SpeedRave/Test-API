...
public class EmployeeRestController {
    ...
    {
        return Response.generate(HttpStatus.OK, "Data Successfully Retreived!", employeeService.Get());
    }

    @GetMapping("employee/{id}")
    public ResponseEntity<Object> get(@PathVariable(required = true) Integer id)
    {
        return Response.generate(HttpStatus.OK, "Data Successfully Retreived!", employeeService.Get(id));
    }
